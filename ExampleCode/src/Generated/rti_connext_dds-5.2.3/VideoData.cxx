        ...
        namespace media {
            namespace generated {
                ...
                RTIBool VideoStream_initialize_w_params(
                    VideoStream* sample, const struct DDS_TypeAllocationParams_t * allocParams)
                {
                    ...
                    if (allocParams->allocate_memory) {
                        ...
                        if (!DDS_OctetSeq_set_maximum(&sample->frame , ((com::rti::media::generated::MAX_BUFFER_SIZE)))) {
                            return RTI_FALSE;
                        }
                    } else { 
                ...
                void VideoStream_finalize_w_params(
                    VideoStream* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
                {
