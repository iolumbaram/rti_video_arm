            ...
            namespace generated {
                ...
                * ------------------------------------------------------------------------- */
                    ...
                    const VideoStream *sample)
                {
                    ...
                    result = com::rti::media::generated::VideoStreamPlugin_serialize(
                    ...
                    unsigned int length)
                {
                    ...
                    return VideoStreamPlugin_deserialize_sample( 
                        NULL, sample,
                ...
                unsigned int 
                VideoStreamPlugin_get_serialized_sample_max_size_ex(
                    PRESTypePluginEndpointData endpoint_data,
                    RTIBool * overflow,
                    RTIBool include_encapsulation,
                    RTIEncapsulationId encapsulation_id,
                    ...
                    unsigned int current_alignment)
                {
                    ...
                    size = VideoStreamPlugin_get_serialized_sample_max_size_ex(
                ...
                * -------------------------------------------------------------------------------------- */
                ...
                unsigned int
                VideoStreamPlugin_get_serialized_key_max_size_ex(
                    PRESTypePluginEndpointData endpoint_data,
                    RTIBool * overflow,
                    RTIBool include_encapsulation,
                    RTIEncapsulationId encapsulation_id,
                    ...
                    unsigned int current_alignment)
                {
                    ...
                    size = VideoStreamPlugin_get_serialized_key_max_size_ex(
                        endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
                    ...
                    const VideoStream *instance)
                {
                    ...
                    if (!com::rti::media::generated::VideoStreamPlugin_serialize_key(
                        ...
                        size = (int)com::rti::media::generated::VideoStreamPlugin_get_serialized_sample_size(
                            endpoint_data,
                            RTI_FALSE,
